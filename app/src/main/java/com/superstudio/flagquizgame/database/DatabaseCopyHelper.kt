...
class DatabaseCopyHelper(context: Context) : SQLiteOpenHelper(context, DB_NAME,null,1) {
    ...
    private fun checkDataBase(): Boolean {
        ...
        try {
            ...
            Toast.makeText(myContext,"DB not exits", Toast.LENGTH_SHORT).show()
        ...
        Log.d("ans : DBpath",DB_PATH + DB_NAME.toString())
        return checkDB != null
    }
    ...
    fun createDataBase() {
        ...
        if (dbExist) {
           ...
           // Toast.makeText(myContext?.applicationContext,"Database is not exist",Toast.LENGTH_SHORT).show()
...
//       Toast.makeText(myContext?.applicationContext,(myDataBase!=null).toS,Toast.LENGTH_SHORT).show()
    }
